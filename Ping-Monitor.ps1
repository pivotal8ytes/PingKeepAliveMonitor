...
$notificationto = "recipient@domain.com"
# specify where the notifications come from
$notificationfrom = "notifier@domain.com"
# specify the SMTP server
$smtpserver = "smtp server host or IP"
cd C:\IT\Powershell_Ping_Monitor
...
if(Test-Connection -ComputerName $_ -Count 1 -ea silentlycontinue)
    {
     ...
     write-host "Available host ---> "$_ -BackgroundColor DarkGreen -ForegroundColor White
     [Array]$available += $_
    }
else
    {
